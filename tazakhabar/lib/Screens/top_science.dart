...
class TopScience extends StatefulWidget {
  const TopScience({Key? key}) : super(key: key);

  @override
  State<TopScience> createState() => _TopScienceState();
}

class _TopScienceState extends State<TopScience> {
  @override
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;
    return Scaffold(
      backgroundColor: blacktheme,
      body: FutureBuilder(future: getGenreNews("science"), builder: (context,AsyncSnapshot snapshot){
        if(snapshot.hasData) {
