...
class TopSports extends StatefulWidget {
  const TopSports({Key? key}) : super(key: key);

  @override
  State<TopSports> createState() => _TopSportsState();
}

class _TopSportsState extends State<TopSports> {
  @override
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;
    return Scaffold(
      backgroundColor: blacktheme,
      body: FutureBuilder(future: getGenreNews("sports"), builder: (context,AsyncSnapshot snapshot){
        if(snapshot.hasData) {
