...
import 'package:tazakhabar/utils/colortheme.dart';
import 'package:tazakhabar/Screens/newsdetail.dart';
import '../backend/apicall.dart';
class TopPublish extends StatefulWidget {

  TopPublish({Key? key}) : super(key: key);

  @override
  State<TopPublish> createState() => _TopPublishState();
}

class _TopPublishState extends State<TopPublish> {
  @override
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;
    return Scaffold(
      backgroundColor: blacktheme,
      body: FutureBuilder(future: getTrendingNews(), builder: (context,AsyncSnapshot snapshot){
        if(snapshot.hasData) {
